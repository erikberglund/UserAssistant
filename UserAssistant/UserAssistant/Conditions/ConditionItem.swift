...
class ConditionItem {
    ...
    init?(key: String, configuration: [String: Any]) throws {

        // ---------------------------------------------------------------------
        //  Initialize non-required variables
        // ---------------------------------------------------------------------
        for (configurationKey, configurationValue) in configuration {
            if configurationKey == "Value" {
                try self.initialize(key: key, value: configurationValue)
            } else {
                try self.initialize(key: configurationKey, value: configurationValue)
            }
        }
    }
